#!/bin/bash
# DIA 18 - USE CASE 1: EXPOSIÇÃO CLIMÁTICA
set -e

echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo "🌡️  DIA 18: USE CASE 1 - EXPOSIÇÃO CLIMÁTICA"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo ""

source activate.sh

cat > examples/usecase_01_climate_exposure.py << 'PYEOF'
"""
...
echo "✅ Use Case 1 criado!"
echo ""
echo "🚀 Executando..."
python examples/usecase_01_climate_exposure.py

git add examples/usecase_01_climate_exposure.py
git add queries/usecase_01_climate_exposure.rq
git add setup/week4/dia18_usecase1.sh
git commit -m "Day 18: Use Case 1 - Climate exposure analysis

- 5 SPARQL queries via Fuseki HTTP endpoint
- Extreme heat exposure: preterm vs term births
- Dose-response: heat days vs birth weight
- Formal query for paper (Listing 1)
- Query file: queries/usecase_01_climate_exposure.rq
"
git push

echo ""
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo "✅ DIA 18 COMPLETO!"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo ""
echo "   [██████░░░░] 60% Semana 4"
echo ""
...
echo "   ⬜ Dia 19: Use Case 2 - Hierarquia"
echo "   ⬜ Dia 20: Checkpoint Guilherme"
echo ""
echo "🎯 PRÓXIMO: DIA 19 - USE CASE 2!"
