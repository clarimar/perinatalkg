#!/bin/bash
# DIA 19 - USE CASE 2: HIERARQUIA GEOGRÁFICA
set -e

echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo "🗺️  DIA 19: USE CASE 2 - HIERARQUIA GEOGRÁFICA"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo ""
...
cat > examples/usecase_02_geographic_hierarchy.py << 'PYEOF'
"""
...
echo "✅ Use Case 2 criado!"
echo ""
echo "🚀 Executando..."
python examples/usecase_02_geographic_hierarchy.py

git add examples/usecase_02_geographic_hierarchy.py
git add queries/usecase_02_geographic_hierarchy.rq
git add data/raw/ibge/geographic_hierarchy.ttl 2>/dev/null || true
git add setup/week4/dia19_usecase2.sh
git commit -m "Day 19: Use Case 2 - Geographic hierarchy navigation

- Brazilian geographic hierarchy in RDF
- Municipality → State → Region traversal
- Birth outcomes aggregated by geographic level
- SPARQL path operators for hierarchy navigation
- Formal query for paper (Listing 2)
- Week 4: 80% complete!
"
git push
...
echo "   ✅ Dia 18: Use Case 1 - Clima"
echo "   ✅ Dia 19: Use Case 2 - Geografia"
echo "   ⬜ Dia 20: Checkpoint Guilherme"
echo ""
echo "🎯 ÚLTIMO DIA: DIA 20 - CHECKPOINT GUILHERME!"
