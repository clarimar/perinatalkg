#!/bin/bash
# DIA 8 - Download IBGE Socioeconômico
set -e

echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo "📊 DIA 8: DOWNLOAD IBGE"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo ""
echo "O que vamos baixar:"
echo "  • População 2022 (Censo)"
echo "  • Renda per capita 2010"
echo "  • IDH-M (Atlas Brasil)"
echo "  • Cobertura: 5.570 municípios"
echo ""

source activate.sh
mkdir -p data/raw/ibge

cat > etl/04_ibge_download.py << 'PYEOF'
"""
...
echo "✅ Script criado!"
echo ""
echo "🚀 Executando download IBGE..."
python etl/04_ibge_download.py

git add etl/04_ibge_download.py setup/week2/dia8_ibge_download.sh
git commit -m "Day 8: IBGE socioeconomic data download script"
git push
