...
cat > docs/tutorials/06_sparql_avancado.py << 'PYEOF'
"""
...
echo "🚀 Executando..."
echo ""
python docs/tutorials/06_sparql_avancado.py

git add docs/tutorials/06_sparql_avancado.py setup/week3/dia12_sparql_avancado.sh
git commit -m "Day 12: Advanced SPARQL tutorial - 7 epidemiological queries

- COUNT, AVG, MIN, MAX aggregations
- FILTER with AND/OR conditions
- GROUP BY with ORDER BY DESC
- Multi-hop queries (birth→mother→type)
- Real epidemiological findings from 100 births
"
git push

echo ""
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo "✅ DIA 12 COMPLETO!"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo ""
echo "   [████░] 40% Semana 3"
echo ""
...
echo "   ⬜ Dia 15: Endpoint SPARQL"
echo ""
echo "🎯 PRÓXIMO: DIA 13 - ONTOLOGIA FORMAL BFO!"
