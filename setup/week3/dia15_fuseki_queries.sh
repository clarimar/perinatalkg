#!/bin/bash
# DIA 15 - DADOS REAIS NO FUSEKI + QUERIES
set -e

echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo "🔍 DIA 15: DADOS REAIS NO FUSEKI"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo ""

source activate.sh

cat > docs/tutorials/08_fuseki_queries.py << 'PYEOF'
"""
...
echo "✅ Tutorial criado!"
echo ""
echo "🚀 Executando queries ao vivo..."
echo ""
python docs/tutorials/08_fuseki_queries.py

git add docs/tutorials/08_fuseki_queries.py
git add setup/week3/dia15_fuseki_queries.sh
git commit -m "Day 15: Live SPARQL queries on Fuseki

- 5 epidemiological queries via HTTP
- Real birth data loaded in triplestore
- BFO alignment verified via SPARQL endpoint
- Use case: high-risk birth identification
- Week 3 complete!
"
git push
...
echo "   ✅ Dia 15: Dados reais + queries ao vivo!"
echo ""
echo "🎯 SEMANA 4: SHACL + Reasoner + Use Cases!"
echo ""
